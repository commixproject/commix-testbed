...
$__tail = <<<'TESTBED_TAIL'
    ...
    <aside class="panel">
      ...
      <p class="explain">Both conditions at once: begin with word characters, and carry no whitespace anywhere.</p>
...
<title>Must start with alphanumerics, no whitespace &middot; commix-testbed</title>
...
<div class="wrap page">
  ...
  <header class="sc-head">
    ...
    <h1>Must start with alphanumerics, no whitespace</h1>
  ...
  <div class="cols">
    <section class="panel live">
      <h2>The page</h2>
      <form action="no_white_chars_start_alphanum.php" method="POST">
