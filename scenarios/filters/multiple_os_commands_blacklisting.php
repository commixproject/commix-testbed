...
$__tail = <<<'TESTBED_TAIL'
    ...
    <aside class="panel">
      ...
      <p class="explain">The command names themselves are matched: <code>echo|wget|nc|whoami|cat|ncat</code> on Unix and <code>powershell|cmd</code> on Windows. The match is on literal text, so anything that hides the letters from the regex without hiding them from the shell gets through.</p>
...
if(isset($addr)){
      if( stristr(php_uname(&#x27;s&#x27;), &#x27;Windows NT&#x27;)){
        # Matches the commands &quot;powershell&quot;,&quot;cmd&quot;
        if(!(preg_match(&#x27;/powershell|cmd/&#x27;,$addr))){
        ...
        # Matches the commands &quot;echo&quot;,&quot;wget&quot;,&quot;nc&quot;,&quot;whoami&quot;,&quot;cat&quot;,&quot;ncat&quot;
        if(!(preg_match(&#x27;/echo|wget|nc|whoami|cat|ncat/&#x27;,$addr))){
            # *nix-based command execution.
...
<title>Command names blacklisted &middot; commix-testbed</title>
...
<div class="wrap page">
  ...
  <header class="sc-head">
    ...
    <h1>Command names blacklisted</h1>
  ...
  <div class="cols">
    <section class="panel live">
      <h2>The page</h2>
      <form action="multiple_os_commands_blacklisting.php" method="POST">
