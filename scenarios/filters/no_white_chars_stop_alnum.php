...
$__tail = <<<'TESTBED_TAIL'
    ...
    <aside class="panel">
      ...
      <p class="explain">End with word characters and carry no whitespace - so the suffix has to satisfy the anchor without putting a space back.</p>
...
<title>Must end with alphanumerics, no whitespace &middot; commix-testbed</title>
...
<div class="wrap page">
  ...
  <header class="sc-head">
    ...
    <h1>Must end with alphanumerics, no whitespace</h1>
  ...
  <div class="cols">
    <section class="panel live">
      <h2>The page</h2>
      <form action="no_white_chars_stop_alnum.php" method="POST">
