...
$__tail = <<<'TESTBED_TAIL'
    ...
    <aside class="panel">
      ...
      <p class="explain">The <code>Referer</code> header is concatenated into an <code>echo</code> and its output comes back on the page.</p>
      <p class="lesson">Referer is attacker-controlled like any other header, and it turns up in exactly the kind of code that ends up shelling out - analytics, logging, redirect handling.</p>
...
<title>Referer header - Echoed through a shell &middot; commix-testbed</title>
...
<div class="wrap page">
  ...
  <header class="sc-head">
    ...
    <h1>Referer header - Echoed through a shell</h1>
  ...
  <div class="cols">
    <section class="panel live">
      <h2>The page</h2>
      <div class="howto"><p>There is nothing to type here: the value is taken from the <b>Referer</b> request header. Change that header and reload.</p><pre><code>GET /scenarios/referer/referer(classic).php
