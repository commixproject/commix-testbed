...
$__tail = <<<'TESTBED_TAIL'
    ...
    <aside class="panel">
      ...
      <p class="explain">The <code>addr</code> cookie is concatenated into a ping and the output is returned.</p>
      <p class="lesson">Cookies are request input like any other, and the fact that the application set the value itself earlier says nothing about what comes back. Anything the client can edit is untrusted, and a cookie is entirely under the client's control.</p>
...
if(!isset($_COOKIE[$cookie_name])) {
    ...
    if( stristr(php_uname(&#x27;s&#x27;), &#x27;Windows NT&#x27;)){
      ...
      echo exec(&quot;ping &quot; . (isset($_COOKIE[$cookie_name]) ? $_COOKIE[$cookie_name] : &#x27;&#x27;));
    } else {
      # Unix-based command execution.
      echo exec(&quot;/bin/ping -c 4 &quot; . (isset($_COOKIE[$cookie_name]) ? $_COOKIE[$cookie_name] : &#x27;&#x27;));
    }
}</code></pre>
      </details>
    </aside>
...
<title>Cookie header - Echoed through a shell &middot; commix-testbed</title>
...
<div class="wrap page">
  ...
  <header class="sc-head">
    ...
    <h1>Cookie header - Echoed through a shell</h1>
