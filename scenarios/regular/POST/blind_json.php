...
$__tail = <<<'TESTBED_TAIL'
    ...
    <aside class="panel">
      ...
      <p class="explain">The JSON case with no output in the response.</p>
...
<title>JSON request body, nothing returned &middot; commix-testbed</title>
...
<div class="wrap page">
  ...
  <header class="sc-head">
    ...
    <h1>JSON request body, nothing returned</h1>
  ...
  <div class="cols">
    <section class="panel live">
      <h2>The page</h2>
      <div class="howto"><p>This page takes no form input - it reads the raw request body. Send it something shaped like this:</p><pre><code>POST /scenarios/regular/POST/blind_json.php
Content-Type: application/json

{"addr":"127.0.0.1"}</code></pre><p class="note">The reply says nothing about the command, so nothing here will look different.</p></div><b><?php
                // JSON request format:
                // {"addr":"127.0.0.1"}
                // read JSon input
                $data_back = json_decode(file_get_contents('php://input'));
