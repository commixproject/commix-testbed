...
$__tail = <<<'TESTBED_TAIL'
    ...
    <aside class="panel">
      ...
      <p class="explain">The injection point sits behind HTTP Basic authentication. The credentials are <code>admin:admin</code>; without them every request comes back 401 and nothing is tested.</p>
...
<title>Behind Basic authentication &middot; commix-testbed</title>
...
<div class="wrap page">
  ...
  <header class="sc-head">
    ...
    <h1>Behind Basic authentication</h1>
  ...
  <div class="cols">
    <section class="panel live">
      <h2>The page</h2>
      <form action="classic_basic_auth.php" method="POST">
