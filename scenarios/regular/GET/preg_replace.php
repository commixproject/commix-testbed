...
<title>Attacker-controlled regex &middot; commix-testbed</title>
...
<div class="wrap page">
  ...
  <header class="sc-head">
    ...
    <h1>Attacker-controlled regex</h1>
  ...
  <div class="cols">
    <section class="panel live">
      <h2>The page</h2>
      <!--               <form action="preg_replace.php" method="GET">
              Enter a string to replace <input type="text" name="replace"> with <input type="text" name="with">
