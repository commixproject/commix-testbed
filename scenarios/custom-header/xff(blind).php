...
$__tail = <<<'TESTBED_TAIL'
    ...
    <aside class="panel">
      ...
      <p class="explain">The same custom-header sink with no output reflected. Unix-only.</p>
      <p class="lesson">The same custom header with no output reflected.</p>
...
<title>Custom header - X-Forwarded-For, nothing returned &middot; commix-testbed</title>
...
<div class="wrap page">
  ...
  <header class="sc-head">
    ...
    <h1>Custom header - X-Forwarded-For, nothing returned</h1>
