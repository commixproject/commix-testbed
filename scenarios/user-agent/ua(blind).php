...
$__tail = <<<'TESTBED_TAIL'
    ...
    <aside class="panel">
      ...
      <p class="explain">The same injection with the output thrown away. Unix-only.</p>
      <p class="lesson">The same header sink with nothing reflected, so it has to be confirmed blind.</p>
...
<title>User-Agent header - Nothing returned &middot; commix-testbed</title>
...
<div class="wrap page">
  ...
  <header class="sc-head">
    ...
    <h1>User-Agent header - Nothing returned</h1>
  ...
  <div class="cols">
    <section class="panel live">
      <h2>The page</h2>
      <div class="howto"><p>There is nothing to type here: the value is taken from the <b>User-Agent</b> request header. Change that header and reload.</p><pre><code>GET /scenarios/user-agent/ua(blind).php
